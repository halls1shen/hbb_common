...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Halls1".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.idc1.cc"];
pub const RS_PUB_KEY: &str = "qIPs96DMcRwamcX4pHaNX+JCuwEGN3bCskj2a+K3kVI=";
